...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Dapi",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4Dapi14DAPIAutoFlowVC")
...
@interface DAPIAutoFlowVC (SWIFT_EXTENSION(Dapi)) <UIAdaptivePresentationControllerDelegate>
- (void)presentationControllerDidDismiss:(UIPresentationController * _Nonnull)presentationController;
@end

@class MessageViewController;

@interface DAPIAutoFlowVC (SWIFT_EXTENSION(Dapi)) <MessageViewControllerDelegate>
...
@interface DAPIAutoFlowVC (SWIFT_EXTENSION(Dapi)) <DPCNumPadDisplayViewControllerDelegate>
...
SWIFT_CLASS("_TtC4Dapi13DAPIConnectVC")
...
@interface DAPIConnectVC (SWIFT_EXTENSION(Dapi)) <MessageViewControllerDelegate>
- (void)messageViewControllerDidTapButton:(MessageViewController * _Nonnull)messageViewController error:(NSError * _Nullable)error;
@end


@interface DAPIConnectVC (SWIFT_EXTENSION(Dapi)) <UIAdaptivePresentationControllerDelegate>
- (void)presentationControllerDidDismiss:(UIPresentationController * _Nonnull)presentationController;
@end
...
@interface DAPIConnectVC (SWIFT_EXTENSION(Dapi)) <WKNavigationDelegate, WKUIDelegate>
- (WKWebView * _Nullable)webView:(WKWebView * _Nonnull)webView createWebViewWithConfiguration:(WKWebViewConfiguration * _Nonnull)configuration forNavigationAction:(WKNavigationAction * _Nonnull)navigationAction windowFeatures:(WKWindowFeatures * _Nonnull)windowFeatures SWIFT_WARN_UNUSED_RESULT;
@end

@class UIColor;

SWIFT_CLASS("_TtC4Dapi14MFAColorScheme")
@interface MFAColorScheme : NSObject
...
SWIFT_CLASS("_TtC4Dapi12MFAParameter")
...
@interface NSError (SWIFT_EXTENSION(Dapi))
...
@interface UIButton (SWIFT_EXTENSION(Dapi))
...
@interface UIImage (SWIFT_EXTENSION(Dapi))
...
@interface UIViewController (SWIFT_EXTENSION(Dapi))
